describe('Blog app', function () {
  ...
  describe('when logged in', function () {
    ...
    it('a blog can be liked', function () {
      ...
      cy.contains(blogData.title).contains('view').click()

      cy.contains(blogData.title).contains('like').click()
    ...
    it('a blog can be deleted', function () {
      ...
      cy.contains(blogData.title).contains('remove').click()
    })
